    ...
    return (
        <div className='service-page-container'>
            ...
            <div className='service-page-contents'>
                ...
                <ServiceLeft ServiceImg={Salesservice} ServiceTitle='SALES' ServiceDesc='Our area of sales covers an extensive range of products, from all types of printers (including tabletop printers, multifunctional photocopiers, and plotters), as well as IT related products such as CCTV, Network essentials, PBAX, Interactive Flat Panels.
                    To know more about the products we provide, please visit our Products Page.' />

                <ServiceRight ServiceImg={Troubleservice} ServiceTitle='TROUBLESHOOTING AND REPAIRS' ServiceDesc='Our excellently trained IT team is skilled in troubleshooting and repair for a wide variety of technical issues that include networking, CCTV, and more.
                ...
                <ServiceLeft ServiceImg={Photoservice} ServiceTitle='PHOTOCOPYING' ServiceDesc='Our Abu Dhabi branch has an established 20+ years old shop exclusively for photocopying. We provide anything from normal printing of black and white, 
                    to t-shirt prints, and business card design and production.' />

                <ServiceRight ServiceImg={Graphicservice} ServiceTitle='GRAPHIC DESIGNING' ServiceDesc='Our goal is striving towards creating the best possible creative designs that entails visuals that are attractive and ensure customer traction. We have a separate team of graphic designers to make sure that your wants and needs are custom designed with utmost intricacy. We develop and design various range of products including Posters, flyers, Branding and Identity, Packaging designs, Print designs, Shirts, Hoodies etc.' />

                <ServiceLeft ServiceImg={Webservice} ServiceTitle='WEBSITE DEVELOPMENT' ServiceDesc='Necessity of a website has gained popularity and importance over the past few years. Our expert and talented team is specialized in creating websites accustomed to your needs. Developing a website, however, is no joke. It’s quite a process depending on the kind of website, and the impact you intend to bring with the website.
