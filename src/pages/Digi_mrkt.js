        ...
        <div>
            ...
            <div className='digi-mrkt-bottom'>
                <div className='digi-mrkt-bottom-card-container'>
                    ...
                    <DigiBox digiimg={Digimrkt2} link={'/digital-marketing/search-engine'}  digititle='Search Engine Optimization (SEO)' dididesc='Search Engine Optimization, is the process of optimizing your website to increase its visibility and ranking in search engine results pages (SERPs). The ultimate goal of SEO is to attract more organic traffic to your website from search engines like Google, Bing, and Yahoo.' />
                    <DigiBox digiimg={Digimrkt3} link={'/digital-marketing/Ppc'} digititle='Pay-Per-Click (PPC) Advertising' dididesc='Pay-Per-Click advertising, is a type of online advertising model in which advertisers pay each time a user clicks on one of their ads. PPC advertising allows you to place ads for your website in prominent positions on search engine results pages (SERPs) and other relevant websites, and you only pay when someone clicks on your ad' />
