...
import Appdev from '../images/ser_rot_appdev.jpg';
      ...
      <section className="banner-section">
        <nav class="navbar navbar-expand-lg navbar-home">
          <div class="nav-item-parent">
            ...
            <button class="navbar-toggler navbar-toggler-home" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
